...
userContent('customFolderIcons/product_logo.svg', new ByteArrayInputStream('''\
  <svg width="800" height="800" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"  aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet">
